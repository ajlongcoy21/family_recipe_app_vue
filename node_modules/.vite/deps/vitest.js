...
var require_type_detect = __commonJS({
  "node_modules/type-detect/type-detect.js"(exports, module) {
    (function(global4, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global4.typeDetect = factory();
    })(exports, function() {
      "use strict";
...
var require_loupe = __commonJS({
  "node_modules/loupe/loupe.js"(exports, module) {
    (function(global4, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global4 = typeof globalThis !== "undefined" ? globalThis : global4 || self, factory(global4.loupe = {}));
...
var require_assertion = __commonJS({
  "node_modules/chai/lib/chai/assertion.js"(exports, module) {
    var config2 = require_config();
    module.exports = function(_chai, util4) {
      var AssertionError2 = _chai.AssertionError, flag = util4.flag;
      ...
      Assertion2.prototype.assert = function(expr, msg, negateMsg, expected, _actual, showDiff) {
        ...
        if (true !== config2.showDiff)
          showDiff = false;
        if (!ok) {
          msg = util4.getMessage(this, arguments);
          var actual = util4.getActual(this, arguments);
          var assertionErrorObjectProperties = {
            actual,
            expected,
            showDiff
          };
          var operator = util4.getOperator(this, arguments);
          if (operator) {
...
var require_expect = __commonJS({
  "node_modules/chai/lib/chai/interface/expect.js"(exports, module) {
    module.exports = function(chai3, util4) {
...
var require_assert = __commonJS({
  "node_modules/chai/lib/chai/interface/assert.js"(exports, module) {
    module.exports = function(chai3, util4) {
      var Assertion2 = chai3.Assertion, flag = util4.flag;
      ...
      assert2.operator = function(val, operator, val2, msg) {
        ...
        test3.assert(
          ...
          "expected " + util4.inspect(val) + " to be " + operator + " " + util4.inspect(val2),
          "expected " + util4.inspect(val) + " to not be " + operator + " " + util4.inspect(val2)
        );
      };
...
// node_modules/vitest/dist/chunk-runtime-chain.be610650.mjs
var import_util = __toESM(require_util(), 1);

// node_modules/vitest/dist/chunk-mock-date.304e29b1.mjs
var import_path5 = __toESM(require_path(), 1);

// node_modules/vitest/dist/chunk-constants.71e8a211.mjs
...
var formatter = (open, close, replace = open) => (input) => {
  let string2 = "" + input;
  let index2 = string2.indexOf(close, open.length);
...
var replaceClose = (string2, close, replace, index2) => {
  ...
  let end = string2.substring(index2 + close.length);
...
var sep = "/";
var delimiter = ":";
var normalize = function(path22) {
  if (path22.length === 0) {
    return ".";
  }
  path22 = normalizeWindowsPath(path22);
  const isUNCPath = path22.match(_UNC_REGEX);
  const hasUNCDrive = isUNCPath && path22.match(_UNC_DRIVE_REGEX);
  const isPathAbsolute = isAbsolute(path22);
  const trailingSeparator = path22[path22.length - 1] === "/";
  path22 = normalizeString(path22, !isPathAbsolute);
  if (path22.length === 0) {
    if (isPathAbsolute) {
      return "/";
    }
  ...
  return isPathAbsolute && !isAbsolute(path22) ? `/${path22}` : path22;
};
...
var resolve = function(...args) {
  ...
  for (let i = args.length - 1; i >= -1 && !resolvedAbsolute; i--) {
    const path22 = i >= 0 ? args[i] : process.cwd();
    if (path22.length === 0) {
      continue;
    }
    resolvedPath = `${path22}/${resolvedPath}`;
    resolvedAbsolute = isAbsolute(path22);
  }
...
function normalizeString(path22, allowAboveRoot) {
  let res = "";
...
var rootDir = resolve(import_url.default.fileURLToPath(import.meta.url), "../../");
var distDir = resolve(import_url.default.fileURLToPath(import.meta.url), "../../dist");
...
function resetModules(modules, resetMocks = false) {
  ...
  modules.forEach((_, path4) => {
    if (skipPaths.some((re) => re.test(path4)))
      return;
    modules.delete(path4);
  });
}
...
// node_modules/vitest/dist/chunk-runtime-rpc.57586b73.mjs
var rpc = () => {
...
// node_modules/vitest/dist/chunk-utils-source-map.bbf3ad19.mjs
var build = {};
...
function formatLine(line, outputTruncateLength) {
  var _a2;
  return cliTruncate(line, (outputTruncateLength != null ? outputTruncateLength : ((_a2 = process.stdout) == null ? void 0 : _a2.columns) || 80) - 4);
}
...
function C(t, e, i) {
  ...
  let T = false;
  n === "value" && a && !a.value && a.get && (n = "get", T = true, i = a.get());
  let u;
...
var getSnapshotData = (snapshotPath, update) => {
  ...
  let dirty = false;
  if (import_fs4.default.existsSync(snapshotPath)) {
    try {
      snapshotContents = import_fs4.default.readFileSync(snapshotPath, "utf8");
...
function ensureDirectoryExists(filePath) {
  try {
    import_fs4.default.mkdirSync(join(dirname(filePath)), { recursive: true });
  } catch {
  }
}
...
${snapshots.join("\n\n")}
`;
  const skipWriting = import_fs4.default.existsSync(snapshotPath) && await ((_a2 = import_fs4.default) == null ? void 0 : _a2.promises.readFile(snapshotPath, "utf8")) === content;
  if (skipWriting)
    return;
  ensureDirectoryExists(snapshotPath);
  await ((_b = import_fs4.default) == null ? void 0 : _b.promises.writeFile(snapshotPath, content, "utf-8"));
}
...
async function saveInlineSnapshots(snapshots) {
  const MagicString = (await import("./chunk-magic-string.efe26975-OPRPXBOD.js")).default;
  const files = new Set(snapshots.map((i) => i.file));
  await Promise.all(Array.from(files).map(async (file) => {
    const map2 = await rpc().getSourceMap(file);
    const snaps = snapshots.filter((i) => i.file === file);
    const code = await import_fs4.promises.readFile(file, "utf8");
    const s = new MagicString(code);
    for (const snap of snaps) {
      const pos = await getOriginalPos(map2, snap);
      const index2 = posToNumber(code, pos);
      replaceInlineSnap(code, s, index2, snap.snapshot);
    }
    const transformed = s.toString();
    if (transformed !== code)
      await import_fs4.promises.writeFile(file, transformed, "utf-8");
  }));
}
...
function prepareSnapString(snap, source, index2) {
  const lineIndex = numberToPos(source, index2).line;
...
${JSON.stringify(stacks)}`);
  ...
  async save() {
    ...
    if ((this._dirty || this._uncheckedKeys.size) && !isEmpty) {
      ...
      status.saved = true;
    } else if (!hasExternalSnapshots && import_fs4.default.existsSync(this.snapshotPath)) {
      if (this._updateSnapshot === "all")
        import_fs4.default.unlinkSync(this.snapshotPath);
      status.deleted = true;
    }
    return status;
  }
  ...
  match({
    ...
    const snapshotIsPersisted = isInline || import_fs4.default.existsSync(this.snapshotPath);
    if (pass && !isInline) {
      this._snapshotData[key] = receivedSerialized;
    }
...
var JestChaiExpect = (chai3, utils) => {
  function def(name, fn2) {
    const addMethod = (n) => {
      utils.addMethod(chai3.Assertion.prototype, n, fn2);
    };
      ...
      get: (target, key, receiver) => {
        ...
        return async (...args) => {
          return obj.then((value) => {
            ...
            throw new Error(`promise rejected "${toString2(err)}" instead of resolving`);
          });
        };
      }
    });
      ...
      get: (target, key, receiver) => {
        ...
        return async (...args) => {
          return wrapper.then((value) => {
            throw new Error(`promise resolved "${toString2(value)}" instead of rejecting`);
          }, (err) => {
...
// node_modules/vitest/dist/chunk-runtime-hooks.5d7073db.mjs
var import_util2 = __toESM(require_util(), 1);
var beforeAll = (fn2, timeout) => getCurrentSuite().on("beforeAll", withTimeout(fn2, timeout != null ? timeout : getDefaultHookTimeout(), true));
var afterAll = (fn2, timeout) => getCurrentSuite().on("afterAll", withTimeout(fn2, timeout != null ? timeout : getDefaultHookTimeout(), true));
var beforeEach = (fn2, timeout) => getCurrentSuite().on("beforeEach", withTimeout(fn2, timeout != null ? timeout : getDefaultHookTimeout(), true));
var afterEach = (fn2, timeout) => getCurrentSuite().on("afterEach", withTimeout(fn2, timeout != null ? timeout : getDefaultHookTimeout(), true));
function withCallback(fn2) {
  return new Promise((resolve2, reject) => fn2((err) => {
    if (err)
      reject(err);
    else
      resolve2();
...
var FakeTimers = class {
  ...
  setSystemTime(now2) {
    if (this._fakingTime) {
      ...
      mockDate(now2 != null ? now2 : this.getRealSystemTime());
...
var VitestUtils = class {
  ...
  mock(path4, factory) {
    this._mocker.queueMock(path4, this.getImporter(), factory);
  }
  unmock(path4) {
    this._mocker.queueUnmock(path4, this.getImporter());
  }
  doMock(path4, factory) {
    this._mocker.queueMock(path4, this.getImporter(), factory);
  }
  doUnmock(path4) {
    this._mocker.queueUnmock(path4, this.getImporter());
  }
  async importActual(path4) {
    return this._mocker.importActual(path4, this.getImporter());
  }
  async importMock(path4) {
    return this._mocker.importMock(path4, this.getImporter());
  }
